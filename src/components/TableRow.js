...
//         setIsSearching(true);
//         setHasError(false);
//         const results = await ProjectDataService.searchProjects(searchTerm);
...
//     try {
//       // First update with basic info from the search results
...
//       // Get full milestone details to ensure we have the most up-to-date data
//       const milestone = await ProjectDataService.getMilestoneDetails(project['Project Number']);
...
//     } catch (error) {
//       console.error('Failed to fetch full milestone details:', error);
//       setHasError(true);
//     }
//   };
...
//       try {
//         if (row.projectNumber && row.projectNumber.length >= 3) {
//           setIsSearching(true);
//           setHasError(false);
//           // Fetch milestone details when user presses Enter
...
//           type="text" 
//           value={row.projectNumber?.startsWith('0000-0000') ? '-' : 
//                 (row.pctLaborUsed ? percentFormatter(row.pctLaborUsed):'')} //percentFormatter.format(row.pctLaborUsed / 100) : '')
//           readOnly 
//           className="centered-input"
//         />
//       </td>
